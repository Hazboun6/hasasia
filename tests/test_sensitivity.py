...
def test_fim():
    ...
    fim = hsen.get_FIM_TMM(GWB_sens.spectra, gamma_gwb=13./3, A_gwb = 6.4e-15, rn_psrs={})
    fim_diag = hsen.get_FIM_TMM_diag_approx(GWB_sens.spectra, gamma_gwb=13./3, A_gwb = 6.4e-15, rn_psrs={})
    fim_fastPTA = hsen.get_FIM_fastPTA_Approx(GWB_sens.spectra, gamma_gwb=13./3, A_gwb = 6.4e-15, rn_psrs={})
    fim_fastPTA_diag = hsen.get_FIM_fastPTA_diag_approx(GWB_sens.spectra, gamma_gwb=13./3, A_gwb = 6.4e-15, rn_psrs={})
